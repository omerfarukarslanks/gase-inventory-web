...
import { WeeklySalesChart, CategoryPieChart } from "@/components/dashboard/Chart";
              ...
              >
                ...
                <div
                  className={`text-sm font-semibold ${
                    tx.tutar < 0 ? "text-red-500" : "text-text"
                  }`}
                >
                  {tx.tutar > 0 ? "+" : ""}
        ...
        <div className="rounded-2xl border border-border bg-surface p-6 shadow-glow">
          ...
          <div className="space-y-3">
            {lowStockItems.map((item, index) => (
              <div
                key={index}
                className="flex items-center justify-between rounded-lg border border-border bg-bg/50 p-3"
              >
                <div className="flex items-center gap-3">
